...
CREATE VIEW activities AS
    SELECT notes.id, notes.body, notes.task_id, notes.user_id, notes.created_at, notes.updated_at, 'Note'::text AS activity_type FROM notes UNION SELECT events.id, events.body, events.task_id, events.user_id, events.created_at, events.updated_at, 'Event'::text AS activity_type FROM events;
...
INSERT INTO schema_migrations (version) VALUES ('20130616170316');

INSERT INTO schema_migrations (version) VALUES ('20130721171701');

INSERT INTO schema_migrations (version) VALUES ('20130926132806');

INSERT INTO schema_migrations (version) VALUES ('20130927135323');

INSERT INTO schema_migrations (version) VALUES ('20131018172545');

INSERT INTO schema_migrations (version) VALUES ('20131021232039');

INSERT INTO schema_migrations (version) VALUES ('20140313020242');

INSERT INTO schema_migrations (version) VALUES ('20140314230953');
